    ...
    public function index()
    {
        if (checkRole('show_resale_units') or @auth()->user()->type == 'admin') {
            ...
            foreach ($units as $unit) {
                if (auth()->id() == $unit->agent_id) {
                    $resaleUnit[] = $unit;
                } else {

                    if ('only_me' == $unit->privacy and auth()->id() == $unit->agent_id) {
                        $resaleUnit[] = $unit;
                    } else if ('public' == $unit->privacy) {
                        $resaleUnit[] = $unit;
                    } else if ('team_only' == $unit->privacy) {
