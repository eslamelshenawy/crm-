        ...
        if ($selection == 'me') {
            ...
            foreach ($resales as $resale) {
                if ($resale->privacy == 'public') {
                    ...
                    $teams = Group::where('team_leader_id', $resale->agent_id)->pluck('team_leader_id')->toArray();
                    $members = [];
        ...
        if ($selection == 'me') {
            ...
            foreach ($rentals as $rental) {
                if ($rental->privacy == 'public') {
                    ...
                    $teams = Group::where('team_leader_id', $rental->agent_id)->pluck('team_leader_id')->toArray();
                    $members = [];
                    foreach ($teams as $team) {
                        $members[] = $team;
                    }
