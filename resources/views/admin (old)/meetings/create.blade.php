            ...
            <div class="box-body">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-default btn-flat"
                            id="addGoldenQuestion" style="background-color: #caa42d; color: #fff;">{{ trans('admin.5_golden_questions') }}</button>
                    <button type="button" class="btn btn-danger btn-flat hidden"
                            id="removeGoldenQuestion">{{ trans('admin.remove') . ' ' . trans('admin.5_golden_questions') }}</button>
                </div>
                <br/>
