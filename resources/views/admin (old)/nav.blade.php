        ...
        <div class="container-fluid">
            ...
            <div class="navbar-header col-md-2">
                ...
                <a href="{{ url(adminPath()) }}" class="logo">
                    ...
                    <span class="logo-lg">
            <img src="{{ url('website_style/images/logo.png') }}" style="max-height: 50px; padding-bottom: 7px">
        </span>
                </a>
            </div>
        @php $color = '#b07d12'; @endphp
        <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse col-md-5" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @endif
                    @if(checkRole('developers')
                    or checkRole('projects')
                    or checkRole('phases')
                    or checkRole('properties')
                    or checkRole('resale_units')
                    or checkRole('rental_units')
                    or checkRole('lands')
                    or auth()->user()->type == 'admin')
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                @if(checkRole('developers') or auth()->user()->type == 'admin')
                                    <li>
                                ...
                                @endif
                                @if(checkRole('projects') or auth()->user()->type == 'admin')
                                ...
                                @endif
                                @if(checkRole('resale_units') or auth()->user()->type == 'admin')
                                ...
                                @endif
                                @if(checkRole('rental_units') or auth()->user()->type == 'admin')
            ...
            <li>
                ...
                @endif href="{{ url(adminPath().'/bank') }}"><i
                    ...
                    @endif
                    <li class="dropdown">
                        <a @if(Request::segment(2) == 'guide' ) class="gold-background"
                           @endif href="{{ url(adminPath().'/inventory') }}" class="dropdown-toggle"
                           data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            <span>{{ trans('admin.guide') }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <form action="{{ url(adminPath().'/guide') }}" method="post"
                                      enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <button style="color: white;font-size: 15px;background-color: transparent;border: 0px;margin-left: 10px"
                                            type="submit" @if(Request::segment(2) == 'guide') class="gold-background"
                                            @endif>
                    ...
                    <li>
                        <a @if(Request::segment(2) == 'sort_projects') class="gold-background"
                           @endif href="{{ url(adminPath().'/sort_projects') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="padding: 0;position: relative;">
                                                <ul id="notifications" class="admin-noti" style="list-style: none">
                                                    @foreach(@\App\ProjectRequest::where('created_at', '<=', date('Y-m-d') . ' 23:59:59')->get() as $row)
                                                        {{ $row->type }}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul id="notifications" class="admin-noti">
                                                @foreach(@\App\AdminNotification::where('created_at', '>=', date('Y-m-d') . ' 00:00:00')->where('created_at', '<=', date('Y-m-d') . ' 23:59:59')->limit(10)->get() as $notify)
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{ url('uploads/'.auth()->user()->image) }}" class="img-circle"
                                     alt="User Image">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url(adminPath().'/agent/'.auth()->user()->id) }}"
