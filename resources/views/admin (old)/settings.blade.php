    ...
    <div class="box">
        ...
        <div class="box-body">
            <form action={{url(adminPath().'/settings')}} method="post" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6 @if($errors->has('ar_title')) has-error @endif">
                    <label>{{ trans('admin.ar_title') }}</label>
                    <input type="text" name="ar_title" class="form-control" value="{{ $settings->ar_title }}"
                           placeholder="{!! trans('admin.ar_title') !!}">
                </div>
                ...
                <div class="form-group col-md-6 @if($errors->has('vision')) has-error @endif">
                    <label>{{ trans('admin.CONSULTANCY').' '.trans('admin.in_english') }}</label>
                    <textarea name="en_CONSULTANCY" rows="6" class="form-control"
                              value="{{ $settings->en_CONSULTANCY }}">{{ $settings->en_CONSULTANCY }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('ar_vision')) has-error @endif">
                    <label>{{ trans('admin.CONSULTANCY').' '.trans('admin.in_arabic') }}</label>
                    <textarea name="ar_CONSULTANCY" rows="6" class="form-control"
                              value="{{ $settings->ar_CONSULTANCY }}">{{ $settings->ar_CONSULTANCY }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('vision')) has-error @endif">
                    <label>{{ trans('admin.DEPARTMENT').' '.trans('admin.in_english') }}</label>
                    <textarea name="en_DEPARTMENT" rows="6" class="form-control"
                              value="{{ $settings->en_DEPARTMENT }}">{{ $settings->en_DEPARTMENT }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('ar_vision')) has-error @endif">
                    <label>{{ trans('admin.DEPARTMENT').' '.trans('admin.in_arabic') }}</label>
                    <textarea name="ar_DEPARTMENT" rows="6" class="form-control"
                              value="{{ $settings->ar_DEPARTMENT }}">{{ $settings->ar_DEPARTMENT }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('vision')) has-error @endif">
                    <label>{{ trans('admin.BROKERAGE').' '.trans('admin.in_english') }}</label>
                    <textarea name="en_BROKERAGE" rows="6" class="form-control"
                              value="{{ $settings->en_BROKERAGE }}">{{ $settings->en_BROKERAGE }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('ar_vision')) has-error @endif">
                    <label>{{ trans('admin.BROKERAGE').' '.trans('admin.in_arabic') }}</label>
                    <textarea name="ar_BROKERAGE" rows="6" class="form-control"
                              value="{{ $settings->ar_BROKERAGE }}">{{ $settings->ar_BROKERAGE }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('vision')) has-error @endif">
                    <label>{{ trans('admin.VALUATION').' '.trans('admin.in_english') }}</label>
                    <textarea name="en_VALUATION" rows="6" class="form-control"
                              value="{{ $settings->en_VALUATION }}">{{ $settings->en_VALUATION }}</textarea>
                </div>
                <div class="form-group col-md-6 @if($errors->has('ar_vision')) has-error @endif">
                    <label>{{ trans('admin.VALUATION').' '.trans('admin.in_arabic') }}</label>
                    <textarea name="ar_VALUATION" rows="6" class="form-control"
                              value="{{ $settings->ar_VALUATION }}">{{ $settings->ar_VALUATION }}</textarea>
                </div>
