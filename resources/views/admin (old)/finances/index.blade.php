                ...
                <div class="modal-body">
                    <form action="{{ url(adminPath().'/add_income') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" type="text" class="col-md-6 form-control"></textarea>
                        </div>
                        <div class="form-group">
                            {!! Form::label(trans('admin.value')) !!}
                            <input name="value" type="number" min="0" class="col-md-6 form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <input name="date" type="text" class="col-md-6 datepicker form-control" readonly >
                        </div>
                        <div class="form-group">
                            {!! Form::label(trans('admin.payment_method')) !!}
