...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            @if($project->developer_pdf)
                <strong>{{ trans('admin.developer_pdf') }} : </strong><a class="fa fa-file" href="{{ url('uploads/' . $project->developer_pdf) }}" target="_blank"></a>
                <br>
                <hr>
            @endif
            @if($project->broker_pdf)
                <strong>{{ trans('admin.broker_pdf') }} : </strong><a class="fa fa-file" href="{{ url('uploads/' . $project->broker_pdf) }}" target="_blank"></a>
                <br>
                <hr>
            @endif
