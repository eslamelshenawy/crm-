...
<head>
  ...
  <title>@if(app()->getLocale() == 'en'){{ App\Setting::first()->title }}@else {{ App\Setting::first()->ar_title }} @endif| Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="{{ url(adminPath().'/') }}"><img src="{{ url('website_style/images/logo.png') }}"></a>

  </div>
  <span class="blu-color bigsp">WELCOME!</span>
  <span class="blu-color smsp"> LOGIN</span>
  <!-- /.login-logo -->
