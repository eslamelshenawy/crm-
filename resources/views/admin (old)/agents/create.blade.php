        ...
        <div class="box-body">
            <form action="{{ url(adminPath().'/agent') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group @if($errors->has('email_password')) has-error @endif col-md-12">
                    ...
                    <input type="password" name="email_password" class="form-control" value="{{ old('email_password') }}"
                           placeholder="{!! trans('admin.email_password') !!}">
                    <span style="color: red">{{ __('admin.please_enable_less_secure_in_gmail') }}</span> <a href="https://myaccount.google.com/lesssecureapps" target="_blank">{{ __('admin.click_here') }}</a>
                </div>
                ...
                <div class="form-group @if($errors->has('type')) has-error @endif col-md-2">
                    ...
                    <input type="checkbox" id="agentType" name="type" class="switch-box" data-on-text="{{ __('admin.yes') }}"
