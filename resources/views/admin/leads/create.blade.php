    ...
    <div class="box">
        ...
        <div class="box-body">
            <form action="{{ url(adminPath().'/leads') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group @if($errors->has('prefix_name')) has-error @endif col-md-4">
                    ...
                    <select name="prefix_name" class="form-control select2"
                        ...
                        <option></option>
                        <option value="mr" @if( old('prefix_name') == 'mr' ) selected @endif >{{ trans('admin.mr') }}</option>
                        <option value="mrs" @if( old('prefix_name') == 'mrs' ) selected @endif>{{ trans('admin.mrs') }}</option>
                        <option value="ms" @if( old('prefix_name') == 'ms' ) selected @endif>{{ trans('admin.ms') }}</option>
                    </select>
                </div>
                ...
                <div class="form-group @if($errors->has('last_name')) has-error @endif col-md-4">
                    ...
                    <input type="text" name="last_name" class="form-control" value="{{ old('last_name') }}"
                           placeholder="{!! trans('admin.last_name') !!}" required>
                </div>
                ...
                <div class="form-group col-md-12">
                    ...
                    <select class="form-control select2" name="agent_id" data-placeholder="{{ __('admin.residential_agent') }}">
                        <option></option>
                        <option value="no_agent" @if( old('agent_id') == 'no_agent' ) selected @endif>no agent</option>
                        @foreach(@\App\User::where('residential_commercial', 'residential')->get() as $agent)
                            <option value="{{ $agent->id }}" @if( old('agent_id') == $agent->id ) selected @endif>{{ $agent->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group {{ $errors->has('buyer_seller') ? 'has-error' : '' }} col-md-2">
                        ...
                        <select class="select2 form-control" id="buyer_seller" name="buyer_seller" style="width: 100%"
                            ...
                            <option></option>
                            <option value="buyer"  @if( old('buyer_seller') == 'buyer' ) selected @endif>{{ trans('admin.buyer') }}</option>
                            <option value="seller" @if( old('buyer_seller') == 'seller' ) selected @endif>{{ trans('admin.seller') }}</option>
                    ...
                    <div class="form-group {{ $errors->has('request_type') ? 'has-error' : '' }} col-md-2">
                        ...
                        <select class="select2 form-control" id="type" name="request_type" style="width: 100%"
                            ...
                            <option></option>
                            <option value="resale" @if( old('request_type') == 'resale' ) selected @endif>{{ trans('admin.resale') }}</option>
                            <option value="rental" @if( old('request_type') == 'rental' ) selected @endif>{{ trans('admin.rental') }}</option>
                            <option value="new_home" @if( old('request_type') == 'new_home' ) selected @endif>{{ trans('admin.new_home') }}</option>
                        </select>
                    </div>
                    <div class="form-group {{ $errors->has('request_location') ? 'has-error' : '' }} col-md-2">
                        ...
                        <select class="select2 form-control" id="location" name="request_location" style="width: 100%"
                            ...
                            @foreach(@\App\Location::all() as $location)
                                <option value="{{ $location->id }}" @if( old('request_location') == $location->id ) selected @endif>{{ $location->{app()->getLocale().'_name'} }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group {{ $errors->has('unit_type') ? 'has-error' : '' }} col-md-2">
                        ...
                        <select class="select2 form-control" id="unit_type" name="request_unit_type" style="width: 100%"
                                data-placeholder="{{ trans('admin.type') }}">
                            <option></option>
                            <option value="commercial" @if( old('request_unit_type') == 'commercial' ) selected @endif>{{ trans('admin.commercial') }}</option>
                            <option value="personal" @if( old('request_unit_type') == 'personal' ) selected @endif>{{ trans('admin.personal') }}</option>
                            <option value="land" @if( old('request_unit_type') == 'land' ) selected @endif>{{ trans('admin.land') }}</option>
                        </select>
                    </div>
                    ...
                    {!! Form::label(trans('admin.project')) !!}
                        <select class="select2 form-control"  name="request_project_id[]" style="width: 100%"
                                data-placeholder="{{ trans('admin.request_project_id') }}" multiple>
                            <option></option>
                            @foreach(App\Project::all() as $project)
                                <option value = "{{ $project->id }}" @if(array_search($project->id, (array)old('request_project_id')) > -1) selected @endif> {{ $project->{app()->getLocale().'_name'} }} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
