<table class="table datatable table-striped table-bordered  dt-responsive nowrap" style="width: 100%"id="leadDataTable">
    <thead>
    <tr>
         <th>
            <div class="checkbox">
        ...
        @foreach($leads as $lead)
            ...
            <tr>
                ...
                {{ $type}}
                 ...
                 @if(DB::table('lead_actions')->where('lead_id', $lead->id)->count() ==2)
                     <td>
                         <i class="fa fa-circle" aria-hidden="true" style="color:green "></i>
                     </td>
                 @elseif (DB::table('lead_actions')->where('lead_id', $lead->id)->count() ==1)
                     <td>
                ...
                @if($lead->favorite)
                    <td>
                        <i class="fa fa-star Fav" td="Fav" style="color: #caa42d "></i>
                    </td>
                @else
                    <td>
                        <i class="fa fa-star Fav" td="Fav" style="color: "></i>
                    </td>
                @endif
                <td>
                    @if ($lead->hot)
