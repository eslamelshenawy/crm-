...
@section('content')
    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class='form-group col-md-3'>
                {!! Form::label('finger_id','Finger ID:') !!}
                {!! Form::number('finger_id',null,['class'=>'form-control']) !!}
            </div>

            <div class="form-group @if($errors->has('role_id')) has-error @endif col-md-3" id="roles">
            ...
            <div class="form-group @if($errors->has('type')) has-error @endif col-md-3">
