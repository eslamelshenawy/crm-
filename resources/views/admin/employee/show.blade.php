        ...
        <div class="row">
            <div class="col-md-2">
                ...
                @if(@$employee->photos->where('code', 'profile')->first()->image)
                    <img src="{{url('uploads/'.$employee->photos->where('code', 'profile')->first()->image) }}"
                         class="img-square lead_image"
        ...
        <div class="tab-content">
            ...
            <div id="salary" class="tab-pane fade">
                ...
                {{--<div class="col-md-12" id="actions">--}}
                    ...
                    {{--<div class="box">--}}
                        ...
                        {{--<div class="box-body">--}}
                            ...
                            {{--{!! Form::open(['method'=>'POST' , 'action'=> ['SalariesController@update',$employee_id],'file'=>'true' ,'enctype'=>'multipart/form-data']) !!}--}}
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        {!! Form::open(['method'=>'POST' , 'action'=> 'EmployeeController@employee_slip']) !!}
                        ...
                        <table class="table datatable table-striped table-bordered  dt-responsive nowrap" style="width:100%">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-check">
                                            <label>
                                                <input type="checkbox" class="custom-control-input" name="foo[]"
                                                       id="foo[]"
                                                       value="{{$salary->paid_date}}">
                                                <span class="label-text"></span>
                                            </label>
                                        </div>
                                    </td>
                                    <td>{{$salary->paid_date}}
                                    <td>{{App\Employee::find($employee->id)->en_first_name}} {{App\Employee::find($employee->id)->en_middle_name}}
                                    <td>{{ @$salary->basic }}</td>
                                    <td>{{ @$salary->gross }}</td>
                                    <td>{{ @$salary->net }}</td>
                            ...
                            <tr>
                                ...
                                <td><h4>{{$toltal_basic_salary}}</h4></td>
                                <td><h4>{{$total_gross}}</h4></td>
                                <td><h4>{{$total_net}}</h4></td>
                                <td><h4>{{$total_full_salary}}</h4></td>
                            </tr>
                        ...
                        <div class="form-check">
                            <label>
                                <input type="checkbox" class="custom-control-input" onclick="toggle(this)" name="chk1"
                                       id="chk1">
                                    ...
                                    <div class="container">
                                        ...
                                        <table class="table datatable table-striped table-bordered  dt-responsive nowrap" style="width:100%">
                                            ...
                                            @foreach($rated_employees as $rated_employee)
                                                {!! Form::open(['method'=>'POST' , 'action'=> 'EmployeeController@updateRate']) !!}
                                                {{ csrf_field() }}
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="stars">
                                                            ...
                                                            <input class="star star-5"
                                                                   id="star-5-{{ $rated_employee['id'] }}"
                                                                   type="radio" name="star-{{ $rated_employee['id'] }}"
                                                                   value="5">
                                                            <label class="star star-5"
                                                                   for="star-5-{{ $rated_employee['id'] }}"
                                                                   id="lstar-5"></label>
                                                            <input class="star star-4"
                                                                   id="star-4-{{ $rated_employee['id'] }}"
                                                                   type="radio" name="star-{{ $rated_employee['id'] }}"
                                                                   value="4">
                                                            <label class="star star-4"
                                                                   for="star-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-4"></label>
                                                            <input class="star star-3"
                                                                   id="star-3-{{ $rated_employee['id'] }}"
                                                                   type="radio" name="star-{{ $rated_employee['id'] }}"
                                                                   value="3">
                                                            <label class="star star-3"
                                                                   for="star-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-3"></label>
                                                            <input class="star star-2"
                                                                   id="star-2-{{ $rated_employee['id'] }}"
                                                                   type="radio" name="star-{{ $rated_employee['id'] }}"
                                                                   value="2">
                                                            <label class="star star-2"
                                                                   for="star-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-2"></label>
                                                            <input class="star star-1"
                                                                   id="star-1-{{ $rated_employee['id'] }}"
                                                                   type="radio" name="star-{{ $rated_employee['id'] }}"
                                                                   value="1">
                                                            <label class="star star-1"
                                                                   for="star-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-1"></label>
                                                    ...
                                                    <td>
                                                        <div class="stars">
                                                            ...
                                                            <input class="star star-5"
                                                                   id="star-5-1-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-1-{{ $rated_employee['id'] }}"
                                                                   value="5">
                                                            <label class="star star-5"
                                                                   for="star-5-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-5"></label>
                                                            <input class="star star-4"
                                                                   id="star-4-1-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-1-{{ $rated_employee['id'] }}"
                                                                   value="4">
                                                            <label class="star star-4"
                                                                   for="star-4-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-4"></label>
                                                            <input class="star star-3"
                                                                   id="star-3-1-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-1-{{ $rated_employee['id'] }}"
                                                                   value="3">
                                                            <label class="star star-3"
                                                                   for="star-3-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-3"></label>
                                                            <input class="star star-2"
                                                                   id="star-2-1-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-1-{{ $rated_employee['id'] }}"
                                                                   value="2">
                                                            <label class="star star-2"
                                                                   for="star-2-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-2"></label>
                                                            <input class="star star-1"
                                                                   id="star-1-1-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-1-{{ $rated_employee['id'] }}"
                                                                   value="1">
                                                            <label class="star star-1"
                                                                   for="star-1-1-{{ $rated_employee['id'] }}"
                                                                   id="lstar-1"></label>
                                                    ...
                                                    <td>
                                                        <div class="stars">
                                                            ...
                                                            <input class="star star-5"
                                                                   id="star-5-2-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-2-{{ $rated_employee['id'] }}"
                                                                   value="5">
                                                            <label class="star star-5"
                                                                   for="star-5-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-5"></label>
                                                            <input class="star star-4"
                                                                   id="star-4-2-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-2-{{ $rated_employee['id'] }}"
                                                                   value="4">
                                                            <label class="star star-4"
                                                                   for="star-4-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-4"></label>
                                                            <input class="star star-3"
                                                                   id="star-3-2-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-2-{{ $rated_employee['id'] }}"
                                                                   value="3">
                                                            <label class="star star-3"
                                                                   for="star-3-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-3"></label>
                                                            <input class="star star-2"
                                                                   id="star-2-2-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-2-{{ $rated_employee['id'] }}"
                                                                   value="2">
                                                            <label class="star star-2"
                                                                   for="star-2-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-2"></label>
                                                            <input class="star star-1"
                                                                   id="star-1-2-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-2-{{ $rated_employee['id'] }}"
                                                                   value="1">
                                                            <label class="star star-1"
                                                                   for="star-1-2-{{ $rated_employee['id'] }}"
                                                                   id="lstar-1"></label>
                                                    ...
                                                    <td>
                                                        <div class="stars">
                                                            ...
                                                            <input class="star star-5"
                                                                   id="star-5-3-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-3-{{ $rated_employee['id'] }}"
                                                                   value="5">
                                                            <label class="star star-5"
                                                                   for="star-5-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-5"></label>
                                                            <input class="star star-4"
                                                                   id="star-4-3-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-3-{{ $rated_employee['id'] }}"
                                                                   value="4">
                                                            <label class="star star-4"
                                                                   for="star-4-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-4"></label>
                                                            <input class="star star-3"
                                                                   id="star-3-3-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-3-{{ $rated_employee['id'] }}"
                                                                   value="3">
                                                            <label class="star star-3"
                                                                   for="star-3-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-3"></label>
                                                            <input class="star star-2"
                                                                   id="star-2-3-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-3-{{ $rated_employee['id'] }}"
                                                                   value="2">
                                                            <label class="star star-2"
                                                                   for="star-2-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-2"></label>
                                                            <input class="star star-1"
                                                                   id="star-1-3-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-3-{{ $rated_employee['id'] }}"
                                                                   value="1">
                                                            <label class="star star-1"
                                                                   for="star-1-3-{{ $rated_employee['id'] }}"
                                                                   id="lstar-1"></label>
                                                    ...
                                                    <td>
                                                        <div class="stars">
                                                            ...
                                                            <input class="star star-5"
                                                                   id="star-5-4-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-4-{{ $rated_employee['id'] }}"
                                                                   value="5">
                                                            <label class="star star-5"
                                                                   for="star-5-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-5"></label>
                                                            <input class="star star-4"
                                                                   id="star-4-4-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-4-{{ $rated_employee['id'] }}"
                                                                   value="4">
                                                            <label class="star star-4"
                                                                   for="star-4-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-4"></label>
                                                            <input class="star star-3"
                                                                   id="star-3-4-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-4-{{ $rated_employee['id'] }}"
                                                                   value="3">
                                                            <label class="star star-3"
                                                                   for="star-3-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-3"></label>
                                                            <input class="star star-2"
                                                                   id="star-2-4-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-4-{{ $rated_employee['id'] }}"
                                                                   value="2">
                                                            <label class="star star-2"
                                                                   for="star-2-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-2"></label>
                                                            <input class="star star-1"
                                                                   id="star-1-4-{{ $rated_employee['id'] }}"
                                                                   type="radio"
                                                                   name="star-4-{{ $rated_employee['id'] }}"
                                                                   value="1">
                                                            <label class="star star-1"
                                                                   for="star-1-4-{{ $rated_employee['id'] }}"
                                                                   id="lstar-1"></label>
                                                    ...
                                                    <td id="btn-submit">
                                                        ...
                                                        <input type="hidden" value="{{$employee_id}}"
                                                               name="employee_id">
                                                        <button type="button" class="btn btn-info rate-submit"
                                                                value="submit"
                                                                emp="{{$employee_id}}"
                                                                rated="{{$rated_employee['id']}}">rate
                                                        </button>
