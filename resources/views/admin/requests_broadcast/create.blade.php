...
@section('content')
    <div class="box">
        ...
        <div class="box-body">
            <form action="{{ url(adminPath().'/requests_broadcast') }}" method="post">
                {{ csrf_field() }}
                <input name="lead" type="hidden" value="-1"/>
                <div class="row">
                ...
                <div class="form-group {{ $errors->has('unit_type_id') ? 'has-error' : '' }} col-md-12">
                    ...
                    <select class="select2 form-control" id="unit_type_id" name="unit_type_id" style="width: 30%"
                ...
                <div class="col-md-12">
                    <button type="submit" class="btn btn-primary btn-lg btn-flat">{{ trans('admin.submit') }}</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        $(document).on('change', '#unit_type', function () {
            ...
            if (usage != 'land') {
                ...
                $('#unit_type_id').prop('disabled', true);
